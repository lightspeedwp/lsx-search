	...
	public function archive_display_count( $tab = '' ) {
		...
		<?php } else { ?>
			<tr class="form-field">
				...
				<td>
					<input type="checkbox" {{#if <?php echo esc_attr( $tab ); ?>_archive_display_clear_button}} checked="checked" {{/if}} name="<?php echo esc_attr( $tab ); ?>_archive_display_clear_button" />
					<small><?php esc_html_e( 'This will display a clear button next to the "result" count', 'lsx-search' ); ?></small>
				</td>
			</tr>
		<?php } ?>
