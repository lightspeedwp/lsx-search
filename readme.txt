...
This plugin integrates LSX Theme deeply with the FacetWP plugin & displays search results with filters. 
...
[Lastest changelogs can be found on GitHub](https://github.com/lightspeeddevelopment/lsx-search/blob/master/changelog.md).
